...
### Background
- **Canvas** (`#f7f8fa`): Fond principal de l'interface.
...
### Accent
- **Accent** (`#0066b1`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#0066b1`): État survol de l'accent.

## 3. Typography Rules
- **Display**: BMWTypeNext, Helvetica Neue, Arial, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: BMWTypeNext, Helvetica Neue, Arial, sans-serif, 400, 1rem/1.6
