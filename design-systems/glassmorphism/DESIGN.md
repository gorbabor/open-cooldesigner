...
> Category: Morphism & Effects · Frosted glass effect with translucent layers, subtle blur, and luminous borders for depth and modern elegance.
...
### Background
- **Canvas** (`#eef6ff`): Fond principal de l'interface.
- **Surface** (`#ffffff`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#102033`): Texte principal et titres.
- **Text secondary** (`#34465f`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#4f8cff`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#4f8cff`): État survol de l'accent.
