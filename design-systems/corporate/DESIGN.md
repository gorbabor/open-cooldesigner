...
name: Corporate
category: Enterprise
description: Sobre, institutionnel, confiance
---

# Design System — Corporate

> Category: Enterprise · Sobre, institutionnel, confiance

## 1. Visual Theme & Atmosphere
Sobre, institutionnel, confiance
...
### Accent
- **Accent** (`#1e3a8a`): Actions, focus, liens et éléments interactifs.
