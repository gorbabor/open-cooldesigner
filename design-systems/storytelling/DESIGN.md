...
> Category: Creative & Artistic · Narrative-driven design using visuals, copy, and interaction to guide users through engaging, emotionally resonant journeys.
...
### Background
- **Canvas** (`#fbf6ee`): Fond principal de l'interface.
- **Surface** (`#fffdf8`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#201914`): Texte principal et titres.
- **Text secondary** (`#4c4037`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#9b5b32`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#9b5b32`): État survol de l'accent.
