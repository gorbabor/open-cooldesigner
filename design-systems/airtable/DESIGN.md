...
### Text
- **Text primary** (`#181d26`): Texte principal et titres.
- **Text secondary** (`#333333`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#1b61c9`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#254fad`): État survol de l'accent.

## 3. Typography Rules
- **Display**: Haas Groot Disp, Haas, -apple-system, system-ui, Segoe UI, Roboto, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: Haas, -apple-system, system-ui, Segoe UI, Roboto, sans-serif, 400, 1rem/1.6
