...
name: Modern
category: Éditorial
description: Style éditorial contemporain, typographie serif, palettes minimales.
---

# Design System — Modern

> Category: Éditorial · Style éditorial contemporain, typographie serif, palettes minimales.

## 1. Visual Theme & Atmosphere
Style éditorial contemporain, typographie serif, palettes minimales.
...
- **Text secondary** (`#5f5f5f`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#1a1a1a`): Actions, focus, liens et éléments interactifs.
