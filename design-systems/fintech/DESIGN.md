...
name: Fintech
category: Fintech
description: Moderne, données, confiance numérique
---

# Design System — Fintech

> Category: Fintech · Moderne, données, confiance numérique

## 1. Visual Theme & Atmosphere
Moderne, données, confiance numérique

## 2. Color Palette & Roles
### Background
- **Canvas** (`#f0fdfa`): Fond principal de l'interface.
- **Surface** (`#ffffff`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#0f172a`): Texte principal et titres.
- **Text secondary** (`#475569`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#0f766e`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#115e59`): État survol de l'accent.
