...
> Category: IA & LLM · Open-source AI infrastructure. Technical, blueprint-style design.
...
### Accent
- **Accent** (`#010120`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#010120`): État survol de l'accent.

## 3. Typography Rules
- **Display**: The Future, Arial, ui-sans-serif, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: The Future, Arial, ui-sans-serif, sans-serif, 400, 1rem/1.6
