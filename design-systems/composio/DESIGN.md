...
> Category: Backend & Data · Tool integration platform. Modern dark with colorful integration icons.
...
### Background
- **Canvas** (`#090b14`): Fond principal de l'interface.
- **Surface** (`#121626`): Cartes, panneaux, zones élevées.
...
### Accent
- **Accent** (`#6d5dfc`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#6d5dfc`): État survol de l'accent.
