...
> Category: SaaS & Productivité · Open-source scheduling. Clean neutral UI, developer-oriented simplicity.
...
### Text
- **Text primary** (`#242424`): Texte principal et titres.
- **Text secondary** (`#111111`): Texte secondaire, légendes, métadonnées.
...
## 3. Typography Rules
- **Display**: Cal Sans, Inter, -apple-system, Segoe UI, Arial, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: Inter, -apple-system, Segoe UI, Arial, sans-serif, 400, 1rem/1.6
