...
- **Surface** (`#f4f5f7`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#0e1318`): Texte principal et titres.
- **Text secondary** (`#3c4043`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#7d2ae8`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#6815d4`): État survol de l'accent.

## 3. Typography Rules
- **Display**: Canva Sans, YS Text, system-ui, -apple-system, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: Canva Sans, YS Text, system-ui, -apple-system, sans-serif, 400, 1rem/1.6
