...
> Category: Creative & Artistic · Playful, minimal design with bright colors, rounded shapes, tactile 3D borders, and friendly illustrations for approachable interfaces.
...
### Background
- **Canvas** (`#fbf9ff`): Fond principal de l'interface.
- **Surface** (`#ffffff`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#1d1b2a`): Texte principal et titres.
- **Text secondary** (`#4f4863`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#6d4aff`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#6d4aff`): État survol de l'accent.
