...
> Category: Developer Tools · React Native platform. Dark theme, tight letter-spacing, code-centric.
...
- **Surface** (`#f6f7f9`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#0b0d12`): Texte principal et titres.
- **Text secondary** (`#353945`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#000020`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#000020`): État survol de l'accent.
