...
name: Clean
category: Minimal
description: Simplicité avec espace blanc généreux, typographie lisible, palette limitée.
---

# Design System — Clean

> Category: Minimal · Simplicité avec espace blanc généreux, typographie lisible, palette limitée.

## 1. Visual Theme & Atmosphere
Simplicité avec espace blanc généreux, typographie lisible, palette limitée.
...
### Accent
- **Accent** (`#0f172a`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#1e293b`): État survol de l'accent.
