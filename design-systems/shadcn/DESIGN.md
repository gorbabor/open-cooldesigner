...
name: Shadcn
category: Minimal
description: Composants minimaux et propres, palette monochrome, motifs utility-first.
---

# Design System — Shadcn

> Category: Minimal · Composants minimaux et propres, palette monochrome, motifs utility-first.

## 1. Visual Theme & Atmosphere
Composants minimaux et propres, palette monochrome, motifs utility-first.

## 2. Color Palette & Roles
### Background
- **Canvas** (`#ffffff`): Fond principal de l'interface.
- **Surface** (`#f4f4f5`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#18181b`): Texte principal et titres.
- **Text secondary** (`#71717a`): Texte secondaire, légendes, métadonnées.
