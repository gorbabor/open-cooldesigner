...
> Category: SaaS & Productivité · Collaboration platform. Momentum typography, blue action system, multi-user accent spectrum.
...
### Background
- **Canvas** (`#f6f8fb`): Fond principal de l'interface.
...
### Accent
- **Accent** (`#00a3a6`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#00a3a6`): État survol de l'accent.
