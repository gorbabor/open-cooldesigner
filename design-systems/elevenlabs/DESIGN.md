...
> Category: IA & LLM · AI voice platform. Dark cinematic UI, audio-waveform aesthetics.
...
- **Accent hover** (`#1a1a1a`): État survol de l'accent.

## 3. Typography Rules
- **Display**: Waldenburg, Waldenburg Fallback, system-ui, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: Inter, Inter Fallback, system-ui, -apple-system, sans-serif, 400, 1rem/1.6
