...
> Category: Media & Consumer · Gaming console retail. Three-surface channel layout, quiet-authority display type, cyan hover-scale.
...
### Accent
- **Accent** (`#0070cc`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#1eaedb`): État survol de l'accent.

## 3. Typography Rules
- **Display**: SST, Playstation SST, Arial, Helvetica, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: SST, Playstation SST, Arial, Helvetica, sans-serif, 400, 1rem/1.6
