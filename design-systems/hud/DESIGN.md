...
# Design System — HUD Design System

> Category: Themed & Unique · Fighter jet / helicopter head-up display. Phosphor green on near-black, all-caps data overlays, angular geometry. Zero ambiguity at speed and altitude.
...
## 3. Typography Rules
- **Display**: IBM Plex Mono, ui-monospace, monospace, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: IBM Plex Mono, ui-monospace, monospace, 400, 1rem/1.6
