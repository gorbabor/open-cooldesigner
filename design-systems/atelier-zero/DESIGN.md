...
> Category: Editorial · Studio · A magazine-grade, collage-driven visual system: warm paper canvas, surreal
...
## 3. Typography Rules
- **Display**: Helvetica Neue, Arial, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: Helvetica Neue, Arial, sans-serif, 400, 1rem/1.6
