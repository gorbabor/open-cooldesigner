...
> Category: Media & Consumer · Space technology. Stark black and white, full-bleed imagery, futuristic.
...
### Text
- **Text primary** (`#f0f0fa`): Texte principal et titres.
- **Text secondary** (`#666666`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#f0f0fa`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#ffffff`): État survol de l'accent.

## 3. Typography Rules
- **Display**: D-DIN-Bold, D-DIN, DIN Alternate, Helvetica Neue, Arial, Verdana, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
- **Body**: D-DIN, DIN Alternate, Helvetica Neue, Arial, Verdana, sans-serif, 400, 1rem/1.6
