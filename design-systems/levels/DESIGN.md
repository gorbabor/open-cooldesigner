...
### Background
- **Canvas** (`#fbf7ef`): Fond principal de l'interface.
- **Surface** (`#ffffff`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#1f2a24`): Texte principal et titres.
- **Text secondary** (`#435147`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#2f8f46`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#2f8f46`): État survol de l'accent.
