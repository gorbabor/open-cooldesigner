...
name: Professional
category: Enterprise
description: Design soigné et prêt pour les affaires, typographie moderne, mises en page structurées.
---

# Design System — Professional

> Category: Enterprise · Design soigné et prêt pour les affaires, typographie moderne, mises en page structurées.

## 1. Visual Theme & Atmosphere
Design soigné et prêt pour les affaires, typographie moderne, mises en page structurées.

## 2. Color Palette & Roles
### Background
- **Canvas** (`#ffffff`): Fond principal de l'interface.
- **Surface** (`#f8f9fb`): Cartes, panneaux, zones élevées.
...
- **Accent hover** (`#1d4ed8`): État survol de l'accent.
