...
> Category: Fintech · Crypto trading. Purple-accented dark UI, data-dense dashboards.
...
- **Surface** (`#121a33`): Cartes, panneaux, zones élevées.
...
### Accent
- **Accent** (`#7132f5`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#7132f5`): État survol de l'accent.
