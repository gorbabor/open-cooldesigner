...
> Category: SaaS & Productivité · Automation platform. Warm orange, friendly illustration-driven.
...
### Background
- **Canvas** (`#fff7ed`): Fond principal de l'interface.
- **Surface** (`#ffffff`): Cartes, panneaux, zones élevées.

### Text
- **Text primary** (`#2d2a26`): Texte principal et titres.
- **Text secondary** (`#574f45`): Texte secondaire, légendes, métadonnées.

### Accent
- **Accent** (`#ff4f00`): Actions, focus, liens et éléments interactifs.
- **Accent hover** (`#ff4f00`): État survol de l'accent.

## 3. Typography Rules
- **Display**: Degular, Inter, system-ui, sans-serif, 700, clamp(2rem, 5vw, 3.5rem)
